...
public class CategoryControllerTest {
    ...
    private static final String PATH = CategoryController.ENDPOINT;
    ...
    public void getCategoryByIdTest() throws Exception {
        ...
        this.mockMvc
                .perform(get(PATH + "/{id}", this.category01.getId()))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name", is(this.category01.getName())))
                .andExpect(jsonPath("$.description", is(this.category01.getDescription())));
    ...
    public void getCategoryByIdWithResourceNotFoundExceptionTest() throws Exception {
        ...
        this.mockMvc
                .perform(get(PATH + "/{id}", this.categories.size() + 1))
                .andDo(print())
    ...
    public void updateCategoryByIdTest() throws Exception {
        ...
        this.mockMvc
                .perform(
                        put(PATH + "/{id}", this.category01.getId())
                                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteCategoryByIdTest() throws Exception {
        ...
        this.mockMvc
                .perform(delete(PATH + "/{id}", this.category01.getId()))
                .andDo(print())
                .andExpect(status().isOk());
    }
}